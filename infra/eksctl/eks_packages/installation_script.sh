...
eksctl create addon --name aws-ebs-csi-driver --cluster eks-cluster --service-account-role-arn arn:aws:iam::910322382104:role/AmazonEKS_EBS_CSI_Driver_Role --region us-east-1 --force
